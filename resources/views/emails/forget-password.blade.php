                ...
                <tr>
                  <td>
                    ...
                    <p
                      ...
                      We heard you lost your password. Oh no! But don't worry! You can use the OTP
                      to reset your password</p>

                    <p
                      style="margin:0 0 30px 0;font-size:16px;line-height:24px;font-family:Verdana,Arial,sans-serif;text-align: center;">
                      <a href="#"
                        style="color: #fff;background-color: #2B4576;text-decoration:none;width:211px;height: 36px;     line-height: 36px;display: inline-block;">{{$token??''}}</a>
